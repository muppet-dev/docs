...
<DynamicCodeBlock lang="ts" code={fs.readFileSync("./content/docs/server/concepts/transports/transport-stdio.ts", "utf-8")} />
...
<DynamicCodeBlock lang="ts" code={fs.readFileSync("./content/docs/server/concepts/transports/transport-sse.ts", "utf-8")} />
...
<DynamicCodeBlock lang="ts" code={fs.readFileSync("./content/docs/server/concepts/transports/transport-hono.ts", "utf-8")} />