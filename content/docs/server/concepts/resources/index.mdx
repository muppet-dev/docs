...
<DynamicCodeBlock lang="ts" code={fs.readFileSync("./content/docs/server/concepts/resources/example-dynamic.txt", "utf-8")} />
...
<DynamicCodeBlock lang="ts" code={fs.readFileSync("./content/docs/server/concepts/resources/example-completions.txt", "utf-8")} />
...
<DynamicCodeBlock lang="ts" code={fs.readFileSync("./content/docs/server/concepts/resources/example-static.txt", "utf-8")} />
...
<DynamicCodeBlock lang="ts" code={fs.readFileSync("./content/docs/server/concepts/resources/example-fetcher.txt", "utf-8")} />
