...
<DynamicCodeBlock lang="ts" code={fs.readFileSync("./content/docs/server/concepts/muppet/example-muppet.txt", "utf-8")} />
...
<DynamicCodeBlock lang="ts" code={fs.readFileSync("./content/docs/server/concepts/muppet/example-bridge.txt", "utf-8")} />
