...
<DynamicCodeBlock lang="ts" code={fs.readFileSync("./content/docs/server/concepts/muppet/example-muppet.ts", "utf-8")} />
...
<DynamicCodeBlock lang="ts" code={fs.readFileSync("./content/docs/server/concepts/muppet/example-bridge.ts", "utf-8")} />
